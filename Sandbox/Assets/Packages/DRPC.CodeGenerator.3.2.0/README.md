...
Current versions: DRPC packages **3.2.0** (release tags are authoritative), `MessageProtocol` **3.0.0** (the unified `[Message]` attribute — see below), `Communication.Network.RUDP.*` / `Communication.Shared` **2.5.1**.
