...
| 커스텀 NetSerialize | QuantizedVector 등 사용자 직렬화 | UniNet (ReplicatedAttribute.Serializer — 정적 Write/Read+Equals 계약, 제너레이터 배선 — [[0020-직렬화-배열-델타-유니넷-단독-구현]]·[[features/custom-netserialize | custom-netserialize]]) | 구현 ✅ |
| FastArray 직렬화 | 배열 델타 동기화 | UniNet (T[]/List&lt;T&gt; 인덱스-옵 요소 델타 — 제너레이터 배선, [[0020-직렬화-배열-델타-유니넷-단독-구현]]·[[features/fastarray-delta | fastarray-delta]]) | 구현 ✅ |
